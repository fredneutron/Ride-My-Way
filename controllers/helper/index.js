...
export default class helper {
  static checkRequest(req) {
    const data = [req.params.id, req.body.passenger_id];
    const error = ['Error: parameter id can not be empty', 'Error: passenger_id can not be empty'];
  ...
  static checkRide(req) {
    const data = [req.body.location, req.body.destination, req.body.date, req.body.time, req.body.prize, req.body.creator_id];
  ...
  static checkUser(req) {
    const data = [req.body.firstname, req.body.lastname, req.body.dob, req.body.gender, req.body.email, req.body.password, req.body.vehicleType, req.body.vehicleModel, req.body.driverLn, req.body.VRN];
