...
export default class Ride {
  ...
  static getAllRides(res) {
    return ride.getAllRide(this.today, res);
  }
  // method for active ride offers for a user
  static getAllActive(req, res) {
    return ride.getActiveUser(this.today, req, res);
  }
  ...
  static getRideSearch(req, res) {
    if (
      ...
      this.isEmpty(req.body.location)) return ride.searchRide(req, res);
    return res.status(400).json({
