...
export default class ride {
  ...
  static addNewRide(req, res) {
    dbConnect.connect();
    dbConnect.query('INSERT INTO rides(ride_location,ride_destination,ride_date,ride_time,ride_prize,ride_owner_id,ride_seat) VALUES($1,$2,$3,$4,$5,$6,$7)', [
      req.body.location,
